...
#generate quadtic terms of variables
...
#1999
plot(pref$ncampus[pref$year==1998]~pref$poptota[pref$year==1998], xlab="population in the prefecture level", ylab = "number of campuses in the prefecture level")


plot(pref$ncampus[pref$year==2000]~pref$poptota[pref$year==2000], xlab="population in the prefecture level", ylab = "number of campuses in the prefecture level")
...
#library(MASS)
#MMMM1<- glm(ncampus ~ l.poptota+ l.fditota+ l.gdptota + l.empavea, family=poisson(link="log"), data = pref,na.action = TRUE)
